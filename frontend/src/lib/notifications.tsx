      ...
      <div className="flex-1 w-0 p-4">
        <div className="flex items-start">
          <div className="flex-shrink-0 pt-0.5">
            <div className="h-10 w-10 rounded-full bg-blue-50 flex items-center justify-center text-brand-point">
              <DollarSign size={20} />
            </div>
          </div>
          <div className="ml-3 flex-1">
            ...
            <p className="mt-1 text-xs text-slate-500">
              Spent <span className="font-semibold text-brand-point">${amount}</span> on "{item}"
            </p>
          </div>
        </div>
      </div>
